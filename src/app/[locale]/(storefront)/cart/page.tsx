...
export default function CartPage() {
  ...
  return (
    <main className="mx-auto max-w-2xl px-4 pt-10 pb-28 sm:px-8 sm:py-14">
      <h1 className="font-display text-3xl font-semibold text-ink">Cart</h1>
      ...
      <div className="mt-8 hidden items-center justify-between border-t border-border-warm pt-6 sm:flex">
